...
(Четвертая лабораторная работа третьего семестра ИТМО)

Реализация приложения для взаимодействия и управления файловой системой, используя SOLID, поведенческие, структурные, порождающие паттерны.
